    ...
    return (
        ...
        <div className="flex justify-center items-center">
            <div className="w-[648px] h-[382px] flex-col flex justify-between items-center rounded-xl mt-10 mb-10 bg-white" style={{ boxShadow: "0px 0px 30px 0 rgba(39,35,67,0.12)" }}>
                ...
                <a href="http://localhost:3000/login" className="flex justify-center items-center w-[584px] relative gap-3 px-6 py-3.5 mb-11 rounded-lg bg-[#bd3c2e] text-white font-semibold capitalize">
